...
enum layers {
  ...
  * |   Z  |   X  |   C  |   V  |   B  |   N  |   M  |   ,  |  Up  |   .  |
  * |-------------+------+------+------+------+------+------+------+------'
  * |Lower |Shift | GUI  | Rise |Space | Bksp |Enter | Left | Down| Right |
  * `---------------------------------------------------------------------'
  */
 [_QWERTY] = LAYOUT_ortho_4x10( \
   ...
   LT(_LOWER,KC_LANG2),KC_LSFT,KC_LALT,LT(_RAISE,KC_LANG1),KC_SPC,KC_BSPC,KC_ENT,KC_LEFT,KC_DOWN,   KC_RGHT\
 ),
  ...
  * |      |      |      |      |      |      |      |      |      |      |
  * |------+------+------+------+------+------+-------------+------+------|
  * |  F13 |  F14 |  F15 |  F16 |  F17 |  F18 | F19  |   [  | F21  |   ]  |
  * |-------------+------+------+------+------+------+------+------+------'
 ...
 [_LOWER] = LAYOUT_ortho_4x10( \
   ...
   KC_F13,  KC_F14,  KC_F15,  KC_F16,  KC_F17,  KC_F18,  KC_F19,  KC_LBRC, KC_F20,  KC_RBRC,  \
 ...
 [_RAISE] = LAYOUT_ortho_4x10( \
   ...
   _______, KC_LGUI, KC_LCTL, _______, KC_LBRC, KC_RBRC, KC_SCLN, KC_COLN, KC_BSLS, KC_SLSH   \
 ),
