...
enum layers {
 ...
 [_QWERTY] = LAYOUT_ortho_4x10( \
   _______, _______, _______, _______,   _______,LT(_LOWER,KC_LANG2),KC_Q,     KC_W,     KC_E,      KC_R,     \
   _______, _______, _______, _______,   _______,       KC_LCTL,     KC_A,     KC_S,     KC_D,      KC_F,  \
   _______, _______, _______, _______,   _______,       KC_LSFT,     KC_Z,     KC_X,     KC_C,      KC_V,  \
   _______, _______, _______, _______,   _______,       KC_1,        KC_2,     KC_3,     KC_4,      KC_SPC \
 ),  
 ...
 [_LOWER] = LAYOUT_ortho_4x10( \
   _______, _______, _______, _______, _______, _______, RGB_TOG, RGB_MOD, RGB_HUD, RGB_HUI, \
   _______, _______, _______, _______, _______, _______, RGB_SAD, RGB_SAI, RGB_VAD, RGB_VAI, \
